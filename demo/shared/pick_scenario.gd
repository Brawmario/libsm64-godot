...
signal scenario_picked(path: String)
...
func _on_initial_scenario_button_pressed() -> void:
	scenario_picked.emit("res://demo/scenarios/initial_scenario.tscn")


func _on_many_marios_button_pressed():
	scenario_picked.emit("res://demo/scenarios/many_marios.tscn")


func _on_flying_range_button_pressed() -> void:
	scenario_picked.emit("res://demo/scenarios/flying_range.tscn")


func _on_bob_omb_battlefield_button_pressed():
	scenario_picked.emit("res://demo/scenarios/bob-omb_battlefield.tscn")
