...
godot::PackedVector2Array LibSM64::audio_tick(int p_queued_frames, int p_desired_frames) {
	...
	std::array<int16_t, 544 * 2 * 2> audio_buffer; // NOLINT(cppcoreguidelines-pro-type-member-init)
...
godot::Array LibSM64::mario_tick(int32_t p_mario_id, const godot::Ref<LibSM64MarioInputs> &p_mario_inputs) {
	...
	struct SM64MarioState sm64_mario_state; // NOLINT(cppcoreguidelines-pro-type-member-init)
...
void LibSM64::set_mario_animation(int32_t p_mario_id, MarioAnimID p_anim_id) {
	ERR_FAIL_COND(p_mario_id < 0);

	sm64_set_mario_animation(p_mario_id, static_cast<int32_t>(p_anim_id));
}
...
int LibSM64::surface_object_create(const godot::Vector3 &p_position, const godot::Quaternion &p_rotation, const godot::Ref<LibSM64SurfaceArray> &p_surfaces) {
	...
	struct SM64ObjectTransform object_transform; // NOLINT(cppcoreguidelines-pro-type-member-init)
...
void LibSM64::_bind_methods() {
	...
	BIND_ENUM_CONSTANT(MARIO_ANIM_SLOW_LEDGE_GRAB);
	BIND_ENUM_CONSTANT(MARIO_ANIM_FALL_OVER_BACKWARDS);
	BIND_ENUM_CONSTANT(MARIO_ANIM_BACKWARD_AIR_KB);
	BIND_ENUM_CONSTANT(MARIO_ANIM_DYING_ON_BACK);
	BIND_ENUM_CONSTANT(MARIO_ANIM_BACKFLIP);
	BIND_ENUM_CONSTANT(MARIO_ANIM_CLIMB_UP_POLE);
	BIND_ENUM_CONSTANT(MARIO_ANIM_GRAB_POLE_SHORT);
	BIND_ENUM_CONSTANT(MARIO_ANIM_GRAB_POLE_SWING_PART1);
	BIND_ENUM_CONSTANT(MARIO_ANIM_GRAB_POLE_SWING_PART2);
	BIND_ENUM_CONSTANT(MARIO_ANIM_HANDSTAND_IDLE);
	BIND_ENUM_CONSTANT(MARIO_ANIM_HANDSTAND_JUMP);
	BIND_ENUM_CONSTANT(MARIO_ANIM_START_HANDSTAND);
	BIND_ENUM_CONSTANT(MARIO_ANIM_RETURN_FROM_HANDSTAND);
	BIND_ENUM_CONSTANT(MARIO_ANIM_IDLE_ON_POLE);
	BIND_ENUM_CONSTANT(MARIO_ANIM_A_POSE);
	BIND_ENUM_CONSTANT(MARIO_ANIM_SKID_ON_GROUND);
	BIND_ENUM_CONSTANT(MARIO_ANIM_STOP_SKID);
	BIND_ENUM_CONSTANT(MARIO_ANIM_CROUCH_FROM_FAST_LONGJUMP);
	BIND_ENUM_CONSTANT(MARIO_ANIM_CROUCH_FROM_SLOW_LONGJUMP);
	BIND_ENUM_CONSTANT(MARIO_ANIM_FAST_LONGJUMP);
	BIND_ENUM_CONSTANT(MARIO_ANIM_SLOW_LONGJUMP);
	BIND_ENUM_CONSTANT(MARIO_ANIM_AIRBORNE_ON_STOMACH);
	BIND_ENUM_CONSTANT(MARIO_ANIM_WALK_WITH_LIGHT_OBJ);
	BIND_ENUM_CONSTANT(MARIO_ANIM_RUN_WITH_LIGHT_OBJ);
	BIND_ENUM_CONSTANT(MARIO_ANIM_SLOW_WALK_WITH_LIGHT_OBJ);
	BIND_ENUM_CONSTANT(MARIO_ANIM_SHIVERING_WARMING_HAND);
	BIND_ENUM_CONSTANT(MARIO_ANIM_SHIVERING_RETURN_TO_IDLE);
	BIND_ENUM_CONSTANT(MARIO_ANIM_SHIVERING);
	BIND_ENUM_CONSTANT(MARIO_ANIM_CLIMB_DOWN_LEDGE);
	BIND_ENUM_CONSTANT(MARIO_ANIM_CREDITS_WAVING);
	BIND_ENUM_CONSTANT(MARIO_ANIM_CREDITS_LOOK_UP);
	BIND_ENUM_CONSTANT(MARIO_ANIM_CREDITS_RETURN_FROM_LOOK_UP);
	BIND_ENUM_CONSTANT(MARIO_ANIM_CREDITS_RAISE_HAND);
	BIND_ENUM_CONSTANT(MARIO_ANIM_CREDITS_LOWER_HAND);
	BIND_ENUM_CONSTANT(MARIO_ANIM_CREDITS_TAKE_OFF_CAP);
	BIND_ENUM_CONSTANT(MARIO_ANIM_CREDITS_START_WALK_LOOK_UP);
	BIND_ENUM_CONSTANT(MARIO_ANIM_CREDITS_LOOK_BACK_THEN_RUN);
	BIND_ENUM_CONSTANT(MARIO_ANIM_FINAL_BOWSER_RAISE_HAND_SPIN);
	BIND_ENUM_CONSTANT(MARIO_ANIM_FINAL_BOWSER_WING_CAP_TAKE_OFF);
	BIND_ENUM_CONSTANT(MARIO_ANIM_CREDITS_PEACE_SIGN);
	BIND_ENUM_CONSTANT(MARIO_ANIM_STAND_UP_FROM_LAVA_BOOST);
	BIND_ENUM_CONSTANT(MARIO_ANIM_FIRE_LAVA_BURN);
	BIND_ENUM_CONSTANT(MARIO_ANIM_WING_CAP_FLY);
	BIND_ENUM_CONSTANT(MARIO_ANIM_HANG_ON_OWL);
	BIND_ENUM_CONSTANT(MARIO_ANIM_LAND_ON_STOMACH);
	BIND_ENUM_CONSTANT(MARIO_ANIM_AIR_FORWARD_KB);
	BIND_ENUM_CONSTANT(MARIO_ANIM_DYING_ON_STOMACH);
	BIND_ENUM_CONSTANT(MARIO_ANIM_SUFFOCATING);
	BIND_ENUM_CONSTANT(MARIO_ANIM_COUGHING);
	BIND_ENUM_CONSTANT(MARIO_ANIM_THROW_CATCH_KEY);
	BIND_ENUM_CONSTANT(MARIO_ANIM_DYING_FALL_OVER);
	BIND_ENUM_CONSTANT(MARIO_ANIM_IDLE_ON_LEDGE);
	BIND_ENUM_CONSTANT(MARIO_ANIM_FAST_LEDGE_GRAB);
	BIND_ENUM_CONSTANT(MARIO_ANIM_HANG_ON_CEILING);
	BIND_ENUM_CONSTANT(MARIO_ANIM_PUT_CAP_ON);
	BIND_ENUM_CONSTANT(MARIO_ANIM_TAKE_CAP_OFF_THEN_ON);
	BIND_ENUM_CONSTANT(MARIO_ANIM_QUICKLY_PUT_CAP_ON);
	BIND_ENUM_CONSTANT(MARIO_ANIM_HEAD_STUCK_IN_GROUND);
	BIND_ENUM_CONSTANT(MARIO_ANIM_GROUND_POUND_LANDING);
	BIND_ENUM_CONSTANT(MARIO_ANIM_TRIPLE_JUMP_GROUND_POUND);
	BIND_ENUM_CONSTANT(MARIO_ANIM_START_GROUND_POUND);
	BIND_ENUM_CONSTANT(MARIO_ANIM_GROUND_POUND);
	BIND_ENUM_CONSTANT(MARIO_ANIM_BOTTOM_STUCK_IN_GROUND);
	BIND_ENUM_CONSTANT(MARIO_ANIM_IDLE_WITH_LIGHT_OBJ);
	BIND_ENUM_CONSTANT(MARIO_ANIM_JUMP_LAND_WITH_LIGHT_OBJ);
	BIND_ENUM_CONSTANT(MARIO_ANIM_JUMP_WITH_LIGHT_OBJ);
	BIND_ENUM_CONSTANT(MARIO_ANIM_FALL_LAND_WITH_LIGHT_OBJ);
	BIND_ENUM_CONSTANT(MARIO_ANIM_FALL_WITH_LIGHT_OBJ);
	BIND_ENUM_CONSTANT(MARIO_ANIM_FALL_FROM_SLIDING_WITH_LIGHT_OBJ);
	BIND_ENUM_CONSTANT(MARIO_ANIM_SLIDING_ON_BOTTOM_WITH_LIGHT_OBJ);
	BIND_ENUM_CONSTANT(MARIO_ANIM_STAND_UP_FROM_SLIDING_WITH_LIGHT_OBJ);
	BIND_ENUM_CONSTANT(MARIO_ANIM_RIDING_SHELL);
	BIND_ENUM_CONSTANT(MARIO_ANIM_WALKING);
	BIND_ENUM_CONSTANT(MARIO_ANIM_FORWARD_FLIP);
	BIND_ENUM_CONSTANT(MARIO_ANIM_JUMP_RIDING_SHELL);
	BIND_ENUM_CONSTANT(MARIO_ANIM_LAND_FROM_DOUBLE_JUMP);
	BIND_ENUM_CONSTANT(MARIO_ANIM_DOUBLE_JUMP_FALL);
	BIND_ENUM_CONSTANT(MARIO_ANIM_SINGLE_JUMP);
	BIND_ENUM_CONSTANT(MARIO_ANIM_LAND_FROM_SINGLE_JUMP);
	BIND_ENUM_CONSTANT(MARIO_ANIM_AIR_KICK);
	BIND_ENUM_CONSTANT(MARIO_ANIM_DOUBLE_JUMP_RISE);
	BIND_ENUM_CONSTANT(MARIO_ANIM_START_FORWARD_SPINNING);
	BIND_ENUM_CONSTANT(MARIO_ANIM_THROW_LIGHT_OBJECT);
	BIND_ENUM_CONSTANT(MARIO_ANIM_FALL_FROM_SLIDE_KICK);
	BIND_ENUM_CONSTANT(MARIO_ANIM_BEND_KNESS_RIDING_SHELL);
	BIND_ENUM_CONSTANT(MARIO_ANIM_LEGS_STUCK_IN_GROUND);
	BIND_ENUM_CONSTANT(MARIO_ANIM_GENERAL_FALL);
	BIND_ENUM_CONSTANT(MARIO_ANIM_GENERAL_LAND);
	BIND_ENUM_CONSTANT(MARIO_ANIM_BEING_GRABBED);
	BIND_ENUM_CONSTANT(MARIO_ANIM_GRAB_HEAVY_OBJECT);
	BIND_ENUM_CONSTANT(MARIO_ANIM_SLOW_LAND_FROM_DIVE);
	BIND_ENUM_CONSTANT(MARIO_ANIM_FLY_FROM_CANNON);
	BIND_ENUM_CONSTANT(MARIO_ANIM_MOVE_ON_WIRE_NET_RIGHT);
	BIND_ENUM_CONSTANT(MARIO_ANIM_MOVE_ON_WIRE_NET_LEFT);
	BIND_ENUM_CONSTANT(MARIO_ANIM_MISSING_CAP);
	BIND_ENUM_CONSTANT(MARIO_ANIM_PULL_DOOR_WALK_IN);
	BIND_ENUM_CONSTANT(MARIO_ANIM_PUSH_DOOR_WALK_IN);
	BIND_ENUM_CONSTANT(MARIO_ANIM_UNLOCK_DOOR);
	BIND_ENUM_CONSTANT(MARIO_ANIM_START_REACH_POCKET);
	BIND_ENUM_CONSTANT(MARIO_ANIM_REACH_POCKET);
	BIND_ENUM_CONSTANT(MARIO_ANIM_STOP_REACH_POCKET);
	BIND_ENUM_CONSTANT(MARIO_ANIM_GROUND_THROW);
	BIND_ENUM_CONSTANT(MARIO_ANIM_GROUND_KICK);
	BIND_ENUM_CONSTANT(MARIO_ANIM_FIRST_PUNCH);
	BIND_ENUM_CONSTANT(MARIO_ANIM_SECOND_PUNCH);
	BIND_ENUM_CONSTANT(MARIO_ANIM_FIRST_PUNCH_FAST);
	BIND_ENUM_CONSTANT(MARIO_ANIM_SECOND_PUNCH_FAST);
	BIND_ENUM_CONSTANT(MARIO_ANIM_PICK_UP_LIGHT_OBJ);
	BIND_ENUM_CONSTANT(MARIO_ANIM_PUSHING);
	BIND_ENUM_CONSTANT(MARIO_ANIM_START_RIDING_SHELL);
	BIND_ENUM_CONSTANT(MARIO_ANIM_PLACE_LIGHT_OBJ);
	BIND_ENUM_CONSTANT(MARIO_ANIM_FORWARD_SPINNING);
	BIND_ENUM_CONSTANT(MARIO_ANIM_BACKWARD_SPINNING);
	BIND_ENUM_CONSTANT(MARIO_ANIM_BREAKDANCE);
	BIND_ENUM_CONSTANT(MARIO_ANIM_RUNNING);
	BIND_ENUM_CONSTANT(MARIO_ANIM_RUNNING_UNUSED);
	BIND_ENUM_CONSTANT(MARIO_ANIM_SOFT_BACK_KB);
	BIND_ENUM_CONSTANT(MARIO_ANIM_SOFT_FRONT_KB);
	BIND_ENUM_CONSTANT(MARIO_ANIM_DYING_IN_QUICKSAND);
	BIND_ENUM_CONSTANT(MARIO_ANIM_IDLE_IN_QUICKSAND);
	BIND_ENUM_CONSTANT(MARIO_ANIM_MOVE_IN_QUICKSAND);
	BIND_ENUM_CONSTANT(MARIO_ANIM_ELECTROCUTION);
	BIND_ENUM_CONSTANT(MARIO_ANIM_SHOCKED);
	BIND_ENUM_CONSTANT(MARIO_ANIM_BACKWARD_KB);
	BIND_ENUM_CONSTANT(MARIO_ANIM_FORWARD_KB);
	BIND_ENUM_CONSTANT(MARIO_ANIM_IDLE_HEAVY_OBJ);
	BIND_ENUM_CONSTANT(MARIO_ANIM_STAND_AGAINST_WALL);
	BIND_ENUM_CONSTANT(MARIO_ANIM_SIDESTEP_LEFT);
	BIND_ENUM_CONSTANT(MARIO_ANIM_SIDESTEP_RIGHT);
	BIND_ENUM_CONSTANT(MARIO_ANIM_START_SLEEP_IDLE);
	BIND_ENUM_CONSTANT(MARIO_ANIM_START_SLEEP_SCRATCH);
	BIND_ENUM_CONSTANT(MARIO_ANIM_START_SLEEP_YAWN);
	BIND_ENUM_CONSTANT(MARIO_ANIM_START_SLEEP_SITTING);
	BIND_ENUM_CONSTANT(MARIO_ANIM_SLEEP_IDLE);
	BIND_ENUM_CONSTANT(MARIO_ANIM_SLEEP_START_LYING);
	BIND_ENUM_CONSTANT(MARIO_ANIM_SLEEP_LYING);
	BIND_ENUM_CONSTANT(MARIO_ANIM_DIVE);
	BIND_ENUM_CONSTANT(MARIO_ANIM_SLIDE_DIVE);
	BIND_ENUM_CONSTANT(MARIO_ANIM_GROUND_BONK);
	BIND_ENUM_CONSTANT(MARIO_ANIM_STOP_SLIDE_LIGHT_OBJ);
	BIND_ENUM_CONSTANT(MARIO_ANIM_SLIDE_KICK);
	BIND_ENUM_CONSTANT(MARIO_ANIM_CROUCH_FROM_SLIDE_KICK);
	BIND_ENUM_CONSTANT(MARIO_ANIM_SLIDE_MOTIONLESS); // unused
	BIND_ENUM_CONSTANT(MARIO_ANIM_STOP_SLIDE);
	BIND_ENUM_CONSTANT(MARIO_ANIM_FALL_FROM_SLIDE);
	BIND_ENUM_CONSTANT(MARIO_ANIM_SLIDE);
	BIND_ENUM_CONSTANT(MARIO_ANIM_TIPTOE);
	BIND_ENUM_CONSTANT(MARIO_ANIM_TWIRL_LAND);
	BIND_ENUM_CONSTANT(MARIO_ANIM_TWIRL);
	BIND_ENUM_CONSTANT(MARIO_ANIM_START_TWIRL);
	BIND_ENUM_CONSTANT(MARIO_ANIM_STOP_CROUCHING);
	BIND_ENUM_CONSTANT(MARIO_ANIM_START_CROUCHING);
	BIND_ENUM_CONSTANT(MARIO_ANIM_CROUCHING);
	BIND_ENUM_CONSTANT(MARIO_ANIM_CRAWLING);
	BIND_ENUM_CONSTANT(MARIO_ANIM_STOP_CRAWLING);
	BIND_ENUM_CONSTANT(MARIO_ANIM_START_CRAWLING);
	BIND_ENUM_CONSTANT(MARIO_ANIM_SUMMON_STAR);
	BIND_ENUM_CONSTANT(MARIO_ANIM_RETURN_STAR_APPROACH_DOOR);
	BIND_ENUM_CONSTANT(MARIO_ANIM_BACKWARDS_WATER_KB);
	BIND_ENUM_CONSTANT(MARIO_ANIM_SWIM_WITH_OBJ_PART1);
	BIND_ENUM_CONSTANT(MARIO_ANIM_SWIM_WITH_OBJ_PART2);
	BIND_ENUM_CONSTANT(MARIO_ANIM_FLUTTERKICK_WITH_OBJ);
	BIND_ENUM_CONSTANT(MARIO_ANIM_WATER_ACTION_END_WITH_OBJ);
	BIND_ENUM_CONSTANT(MARIO_ANIM_STOP_GRAB_OBJ_WATER);
	BIND_ENUM_CONSTANT(MARIO_ANIM_WATER_IDLE_WITH_OBJ);
	BIND_ENUM_CONSTANT(MARIO_ANIM_DROWNING_PART1);
	BIND_ENUM_CONSTANT(MARIO_ANIM_DROWNING_PART2);
	BIND_ENUM_CONSTANT(MARIO_ANIM_WATER_DYING);
	BIND_ENUM_CONSTANT(MARIO_ANIM_WATER_FORWARD_KB);
	BIND_ENUM_CONSTANT(MARIO_ANIM_FALL_FROM_WATER);
	BIND_ENUM_CONSTANT(MARIO_ANIM_SWIM_PART1);
	BIND_ENUM_CONSTANT(MARIO_ANIM_SWIM_PART2);
	BIND_ENUM_CONSTANT(MARIO_ANIM_FLUTTERKICK);
	BIND_ENUM_CONSTANT(MARIO_ANIM_WATER_ACTION_END);
	BIND_ENUM_CONSTANT(MARIO_ANIM_WATER_PICK_UP_OBJ);
	BIND_ENUM_CONSTANT(MARIO_ANIM_WATER_GRAB_OBJ_PART2);
	BIND_ENUM_CONSTANT(MARIO_ANIM_WATER_GRAB_OBJ_PART1);
	BIND_ENUM_CONSTANT(MARIO_ANIM_WATER_THROW_OBJ);
	BIND_ENUM_CONSTANT(MARIO_ANIM_WATER_IDLE);
	BIND_ENUM_CONSTANT(MARIO_ANIM_WATER_STAR_DANCE);
	BIND_ENUM_CONSTANT(MARIO_ANIM_RETURN_FROM_WATER_STAR_DANCE);
	BIND_ENUM_CONSTANT(MARIO_ANIM_GRAB_BOWSER);
	BIND_ENUM_CONSTANT(MARIO_ANIM_SWINGING_BOWSER);
	BIND_ENUM_CONSTANT(MARIO_ANIM_RELEASE_BOWSER);
	BIND_ENUM_CONSTANT(MARIO_ANIM_HOLDING_BOWSER);
	BIND_ENUM_CONSTANT(MARIO_ANIM_HEAVY_THROW);
	BIND_ENUM_CONSTANT(MARIO_ANIM_WALK_PANTING);
	BIND_ENUM_CONSTANT(MARIO_ANIM_WALK_WITH_HEAVY_OBJ);
	BIND_ENUM_CONSTANT(MARIO_ANIM_TURNING_PART1);
	BIND_ENUM_CONSTANT(MARIO_ANIM_TURNING_PART2);
	BIND_ENUM_CONSTANT(MARIO_ANIM_SLIDEFLIP_LAND);
	BIND_ENUM_CONSTANT(MARIO_ANIM_SLIDEFLIP);
	BIND_ENUM_CONSTANT(MARIO_ANIM_TRIPLE_JUMP_LAND);
	BIND_ENUM_CONSTANT(MARIO_ANIM_TRIPLE_JUMP);
	BIND_ENUM_CONSTANT(MARIO_ANIM_FIRST_PERSON);
	BIND_ENUM_CONSTANT(MARIO_ANIM_IDLE_HEAD_LEFT);
	BIND_ENUM_CONSTANT(MARIO_ANIM_IDLE_HEAD_RIGHT);
	BIND_ENUM_CONSTANT(MARIO_ANIM_IDLE_HEAD_CENTER);
	BIND_ENUM_CONSTANT(MARIO_ANIM_HANDSTAND_LEFT);
	BIND_ENUM_CONSTANT(MARIO_ANIM_HANDSTAND_RIGHT);
	BIND_ENUM_CONSTANT(MARIO_ANIM_WAKE_FROM_SLEEP);
	BIND_ENUM_CONSTANT(MARIO_ANIM_WAKE_FROM_LYING);
	BIND_ENUM_CONSTANT(MARIO_ANIM_START_TIPTOE);
	BIND_ENUM_CONSTANT(MARIO_ANIM_SLIDEJUMP);
	BIND_ENUM_CONSTANT(MARIO_ANIM_START_WALLKICK);
	BIND_ENUM_CONSTANT(MARIO_ANIM_STAR_DANCE);
	BIND_ENUM_CONSTANT(MARIO_ANIM_RETURN_FROM_STAR_DANCE);
	BIND_ENUM_CONSTANT(MARIO_ANIM_FORWARD_SPINNING_FLIP);
	BIND_ENUM_CONSTANT(MARIO_ANIM_TRIPLE_JUMP_FLY);
